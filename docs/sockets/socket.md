...
- _SOCK_STREAM_ Provides sequenced, reliable, two-way, connection-based byte streams. An out-of-band data transmission mechanism may be supported.

- _SOCK_DGRAM_ Supports datagrams (connectionless, unreliable messages of a fixed maximum length).
